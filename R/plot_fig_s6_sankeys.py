...
# =============================================================================
CACHE_Z = os.path.join("data", "cache_z_stimulants_flows.pkl")
# v2 Y cache: stores demand_cat column so different cats can be used per group
CACHE_Y = os.path.join("data", "cache_y_stimulants_v2_flows.pkl")
