...
year <- 2020
str_fp_landuse <- readRDS(paste0("./data/stressor footprints/str_footprint_",year,".rds"))[['landuse']]
str_fp_water <- readRDS(paste0("./data/stressor footprints/str_footprint_",year,".rds"))[['blue']]
str_fp_N <- readRDS(paste0("./data/stressor footprints/str_footprint_",year,".rds"))[['n_application']]
str_fp_P <- readRDS(paste0("./data/stressor footprints/str_footprint_",year,".rds"))[['p_application']]
str_fp_CO2 <- readRDS(paste0("./data/stressor footprints/str_footprint_",year,".rds"))[['CO2']]
str_fp_CH4 <- readRDS(paste0("./data/stressor footprints/str_footprint_",year,".rds"))[['CH4']]
str_fp_NO2 <- readRDS(paste0("./data/stressor footprints/str_footprint_",year,".rds"))[['NO2']]
