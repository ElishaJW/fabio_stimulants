...
#? Pivoting table to match CBS data in R code

#%%
# LIST OF COLUMN NAMES, IN ORDER, OF CBS
# 'area_code', 'area', 'item_code', 'item', 'year', 'total_supply', 'exports', 'Fat supply quantity (t)',
# 'feed', 'food', 'Food supply (kcal)', 'imports', 'losses', 'other', 'processing', 'production',
# 'Protein supply quantity (t)', 'residuals', 'seed', 'stock_withdrawal', 'tourist', 'stock_addition', 'balancing', 'unspecified'

#%%
#? Create a version of the SUA data with the 'element', or 'uses', as the column names
# This should match the cbs data in the Rscript by the end
...
sua_pivot <- reshape2::dcast(sua, area_code + area + item_code + item + year ~ element, value.var = "value")
...
colnames(sua_pivot) <- c('area_code', 'area', 'item_code', 'item', 'year',
                         ...
                         'Food supply (kcal)', 'imports', 'losses', 'other',
                         'processing', 'production', 'Protein supply quantity (t)',
                         'residuals', 'exports', 'imports', 'seed', 'stock_withdrawal',
                         'tourist', 'stock_addition')
...
# #Supply-------------------------------------------------------------------------
# 
# I have realized that everything I have completed below is not useful.
# Essentially I was building the supply use tables from scratch, but of course,
# I can just add the SUA data much earlier in the process (03_build_cbs.R)
#
#
#
#
